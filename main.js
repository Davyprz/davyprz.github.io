...
const messages = [
    "Haz click para recibir tus mensajes...",
    "Hola ChicoLindo❤️",
    "Primero de todo...",
    "¡Feliz San Valentin!",
    "Espero que te haya gustado el ramo :)",
    "Y si estas leyendo esto es que todo va según lo planeado",
    "Y es que me he propuesto que el día de hoy sea especial",
    "Soy muy consciente de que la fecha de hoy no cambia nada...",
    "Simplemente un día para hacer protagonista el amor que nos tenemos a diario",
    "Por eso, el día de hoy tratará de ello",
    "De pasarlo bien juntos y que seas consciente de lo mucho que te quiero.",
    "Así que... pondremos en marcha un juego te parece?",
    "Para jugar habra que inciarlo, por lo tanto que te parece si vamos empezando...",
